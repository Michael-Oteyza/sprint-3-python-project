...
## a) create a dictionary - key = genre - value = total global sales
sales_by_genre = {}
...
for game in video_game_sales:
    ...
    if genre in sales_by_genre:
        sales_by_genre[genre] += total_global_sales
    else:
        sales_by_genre[genre] = total_global_sales

print(sales_by_genre)

## b) games per publisher
games_per_publisher = {}
...
## c) print each pair using loop of created dictionary
top_game = {}
