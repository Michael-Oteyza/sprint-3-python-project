...
## 1.b) average global sales
total_global_sales = 0
avg_global_sales = 0
i = 0

for g_sales in video_game_sales:
    total_global_sales += video_game_sales[i][9]
    i += 1

avg_global_sales = total_global_sales / total_games
print(f"The average global sales is ${avg_global_sales}M.")

## 1.c) Percent of total global sales
top_game_share = video_game_sales[0][9] / total_global_sales * 100
print(f"{top_game_share}%")
