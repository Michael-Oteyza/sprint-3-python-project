...
## b) add new game to list and print list
...
## c) create tuple and print
total_games = 0
for game in video_game_sales:
    total_games += 1
dataset_info = (total_games, 10, 'Video Game Sales')
print(dataset_info)
## Normally, the number of games and columns would not change. The same goes for the name of the dataset. If the name needed to be changed, then a new dataset would be created instead.
