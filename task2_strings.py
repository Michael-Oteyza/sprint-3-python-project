...
## b) strip whitespace and convert to lowercase
i = 0
for name in messy_names:
    print(messy_names[i].strip().lower())
    i += 1

## c) print using f-string
first_game = video_game_sales[0]
print(f"#{first_game[RANK]} Best Seller: {first_game[NAME]} ({first_game[YEAR]}) - ${first_game[GLOBAL_SALES]}M global sales")
